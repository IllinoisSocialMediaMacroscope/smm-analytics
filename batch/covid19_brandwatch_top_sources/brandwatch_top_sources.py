...
def brandwatch_top_sources(projectStartDate, projectEndDate, localPath):
...
def lambda_handler(event, context):
    ...
    fnames = brandwatch_top_sources(dayBeforeYesterday.strftime("%Y-%m-%d"), yesterday.strftime("%Y-%m-%d"),
                                 localPath)
    for fname in fnames:
